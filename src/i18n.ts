    ...
    resources: {
      en: {
        translation: {
          ...
          "close": "Close",
          "memory_warning": "May error on smartphones and tablets due to insufficient memory.",
          "exit": "Exit",
          "save": "Save",
      ...
      ja: {
        translation: {
          ...
          "close": "閉じる",
          "memory_warning": "スマートフォン、タブレットの場合は<br></br>メモリ不足のため途中でエラーになる可能性があります",
          "exit": "終了する",
          "save": "保存する",
